Off[General::spell]
Model`Name      = "THDMIIIRHN";
Model`NameLaTeX = "THDMIIIRHN Model";
...
FermionFields[[6]] = {n , 3, conj[nR],       0, 1,  1};
...
LagFer   = Yd conj[H].d.q + Ye conj[H].e.l + Yu Et.u.q + epsD conj[Et].d.q + epsE conj[Et].e.l + epsU H.u.q + epsN Et.n.l + Yn H.n.l;
LagNV    = -(+ 1/2 Mn n.n);
